...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "𝕭𝖎𝖈𝖔𝖒𝖆𝖗𝖚 𝕾𝖍𝖔𝖌𝖚𝖓𝖆~Kun",
    ownernumber: process.env.Owner_Number || "221760263631",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@𝕭𝖎𝖈𝖔𝖒𝖆𝖗𝖚 𝕾𝖍𝖔𝖌𝖚𝖓𝖆ī",
    ...
    sessionId: process.env.SESSION_ID || "MmY2ZTR_Queen-Anya_ta2w=",
